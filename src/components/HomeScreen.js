        ...
        <Card isFlat>
          <Grid md={6}>
            ...
            >
              ...
              <CardBody>
                <Button variant="tertiary" onClick={() => history.push('category/11')} isBlock>View My Gear</Button>
                <br />
                <Button variant="tertiary" onClick={() => history.push('/backpack')} isBlock>View My Backpack</Button>
                <br />
                <Button variant="tertiary" onClick={() => history.push('/add-gear')} isBlock>Add Gear</Button>
              </CardBody>
